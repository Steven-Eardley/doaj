...
def validate(obj, schema):
    ...
    for k, v in obj.items():
        ...
        if k in schema.get("fields", []):
            if not isinstance(v, str) and not isinstance(v, str) and not isinstance(v, int) and not isinstance(v, float):
        ...
        if k in schema.get("lists", []):
            ...
            if entry_schema is None:
                ...
                for e in v:
                    if not isinstance(e, str) and not isinstance(e, str) and not isinstance(e, int) and not isinstance(e, float):
