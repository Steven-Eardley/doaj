...
languages_iso639_2 = [
    ...
    ["cpf", "", "", "Creoles and pidgins, French-based u", "créoles et pidgins basés sur le français"],
    ["cpp", "", "", "Creoles and pidgins, Portuguese-based u", "créoles et pidgins basés sur le portugais"],
    ["cre", "", "cr", "Cree", "cree"],
    ["crh", "", "", "Crimean Tatar; Crimean Turkish", "tatar de Crimé"],
    ["crp", "", "", "Creoles and pidgins u", "créoles et pidgins"],
...
languages_dict = OrderedDict(sorted(list(languages.items()), key=lambda x: x[1]['name']))
...
def get_currency_code(name):
    if name in list(currency_name_map.keys()):
        return name
    for k, v in currency_name_map.items():
